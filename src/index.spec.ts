...
describe('rule engine', () => {
  it('should evaluate', () => {
    ...
    expect(evaluate<Input, Output>(ruleDefinitions, { input1: 'another value', input2: 'world' })).toEqual({
      flag1: false,
      flag2: true,
    });
    expect(evaluate<Input, Output>(ruleDefinitions, { input1: 'another value', input2: 'another value' })).toEqual({
      flag1: false,
      flag2: false,
    });
  });
